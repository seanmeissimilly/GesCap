...
public class EncReaccion {
    ...
    public EncReaccion() {
        ...
        this.cua_dirplan2 = 0;
        this.cua_dirplan3 = 0;
        this.cua_ejecreal1 = 0;
        this.cua_ejecreal2 = 0;
        this.cua_ejecreal3 = 0;
        this.cua_ejecplan1 = 0;
        this.cua_ejecplan2 = 0;
        this.cua_ejecplan3 = 0;
        this.resultado1 = 0;
        this.resultado2 = 0;
        this.resultado3 = 0;
        this.resultado4 = 0;
    ...
    public int getCua_ejecreal1() {
        return cua_ejecreal1;
    }

    public void setCua_ejecreal1(int cua_ejecreal1) {
        this.cua_ejecreal1 = cua_ejecreal1;
    }

    public int getCua_ejecreal2() {
        return cua_ejecreal2;
    }

    public void setCua_ejecreal2(int cua_ejecreal2) {
        this.cua_ejecreal2 = cua_ejecreal2;
    }

    public int getCua_ejecreal3() {
        return cua_ejecreal3;
    }

    public void setCua_ejecreal3(int cua_ejecreal3) {
        this.cua_ejecreal3 = cua_ejecreal3;
    }

    public int getCua_ejecplan1() {
        return cua_ejecplan1;
    }

    public void setCua_ejecplan1(int cua_ejecplan1) {
        this.cua_ejecplan1 = cua_ejecplan1;
    }

    public int getCua_ejecplan2() {
        return cua_ejecplan2;
    }

    public void setCua_ejecplan2(int cua_ejecplan2) {
        this.cua_ejecplan2 = cua_ejecplan2;
    }

    public int getCua_ejecplan3() {
        return cua_ejecplan3;
    }

    public void setCua_ejecplan3(int cua_ejecplan3) {
        this.cua_ejecplan3 = cua_ejecplan3;
    }
